...
//      console.log(successResponse.data)
  ...
  onDeleteAccount(userAccount) {
    ...
    var confirm = this.$mdDialog.prompt()
          .title("Would you like to remove this ServiceNow integration with Yellowant?")
          .textContent(`Please type in your ServiceNow handle to confirm: ${userAccount.user_invoke_name}`)
          .placeholder("Servicenow-handle")
          .ariaLabel("Servicenow Handle")
